...
```sh
- min-content: Độ dài của phần tử dựa vào chữ có độ dài lớn nhất
- max-content: Nội dung content sẽ không xuống hàng -> xuất hiện thanh scroll
- fit-content: Nội dung content sẽ xuống hàng khi độ dài vượt quá kích thước cho phép
```
