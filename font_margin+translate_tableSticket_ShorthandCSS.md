...
$ animation: duration name delay direction interation-count timing-function;
$ transition: property duration timing-function delay;
$ flex: flex-grow shrink flex-basis;
$ flex-flow: flex-direction wrap;
$ border-radius: top-left top-right bottom-right bottom-left;
```
[Tiếp theo >>](./clipathPolygon.md)
[<< Quay về](./inherit+initial+unset_position+visibility_opacity_lineargradient.md)